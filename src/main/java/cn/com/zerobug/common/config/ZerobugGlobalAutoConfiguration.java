 ...
 */
@Configuration
@EnableConfigurationProperties(ZerobugProperties.class)
public class ZerobugGlobalAutoConfiguration {

    @ConditionalOnProperty(prefix = "zerobug", value = {"enableGlobalConfig"}, havingValue = "true")
